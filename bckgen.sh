...
echo "# Run this script to call the main BackupMaker script. Third argument is backup directory name. Fourth argument is debug_flag(0 or 1)." >> $BACKUP_SCRIPT_DEPLOYER_FILENAME
